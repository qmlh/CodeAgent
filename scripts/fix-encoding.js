/**
 * Fix encoding issues in TypeScript/TSX files
 * This script identifies and fixes files with corrupted Chinese characters
 */
...
// Additional patterns for more complex fixes
const patternFixes = [
  {
    pattern: /(\w+)�(\w*)/g,
    replacement: (match, before, after) => {
      // Try to guess the missing character based on context
      const commonEndings = {
        '另存': '另存为',
        '全': '全选',
        '资源管理': '资源管理器',
