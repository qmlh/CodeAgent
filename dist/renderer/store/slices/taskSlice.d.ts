...
export declare const setSelectedTask: import("@reduxjs/toolkit").ActionCreatorWithPayload<string | null, "task/setSelectedTask">, updateTaskStatus: import("@reduxjs/toolkit").ActionCreatorWithPayload<{
    ...
    taskId: string;
    tag: string;
}, "task/removeTaskTag">, setFilterStatus: import("@reduxjs/toolkit").ActionCreatorWithPayload<"pending" | "all" | "failed" | "completed" | "in_progress" | "blocked", "task/setFilterStatus">, setFilterPriority: import("@reduxjs/toolkit").ActionCreatorWithPayload<"all" | "medium" | "high" | "low" | "critical", "task/setFilterPriority">, setFilterAssignee: import("@reduxjs/toolkit").ActionCreatorWithPayload<string, "task/setFilterAssignee">, setSortBy: import("@reduxjs/toolkit").ActionCreatorWithPayload<"status" | "createdAt" | "priority" | "dueDate", "task/setSortBy">, setSortOrder: import("@reduxjs/toolkit").ActionCreatorWithPayload<"desc" | "asc", "task/setSortOrder">, setSearchQuery: import("@reduxjs/toolkit").ActionCreatorWithPayload<string, "task/setSearchQuery">, clearFilters: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"task/clearFilters">, clearError: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<"task/clearError">;
